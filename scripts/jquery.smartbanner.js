...
!function ($) {
    ...
    $.smartbanner.defaults = {
        ...
        icon: 'https://lh4.ggpht.com/Q34rJ27_gvguoEl9Y6xwD6NoJNZ5rPQfR-VJEFT-5BGEMYOYR12QZNEkKLA9H0YUSjaP=w300-rw', // The URL of the icon (defaults to <meta name="apple-touch-icon">)
